...
sociales** que requieren de intervención desde el ámbito público, y para
ello, es \*necesario gestionar planes, programas o proyectos que
...
o más importante que el objetivo mismo que se desea alcanzar, debido a
que **permite analizar la planificación y retroalimentar** del proceso
de ejecución **a través de la medición del impacto que generan las
políticas** para la comunidad. (Recchioni, [2016](#ref-Recchioni2016),
p. 162)

**Es aquí donde el análisis estadísitico toma relevancia** dentro de las
políticas públicas, puesto que, se emplea como una herramienta
indispensable en el análisis cualitativo o cuantitativo de información,
siendo dicho procedimiento escencial en el momento de diseñar planes de
evaluación de políticas.

Y es por ello que, **todo expertos en políticas públicas, debe
desarrollar una fuerte fundamentación en análisis de datos**, debido a
que éstos deben enfrentarse de forma continua a problemas que requieren
la tomar decisiones, basandos en informes estadísticos descriptivos o
...
construida a partir del Censo de Edificaciones que posee el DANE para el
periodo comprendido entre 2011-2018. Dicha base de datos puede ser
descargada desde el siguiente
[Link](https://github.com/jiperezga/jiperezga.github.io/raw/master/Dataset/CesoEdificaciones2011-2018.csv){:target="\_blank"}.
...
-   **<tt>OB\_FORMAL</tt>:** Define si la obra cuenta o no con licencia
    ...
    -   Si = 1
    -   No = 2
-   **<tt>ESTADO\_ACT</tt>:** Ampliación o adición de metros cuadrados a
    la obra
    -   Si = 1
    -   No = 2
-   **<tt>ESTADO\_ACT</tt>:** El movimiento es el código de cambio de
    estado
    -   C = continua
    -   I = inactiva
    -   N = nueva
...
vista, se explica en esta sección el método de implementación en
<tt>R</tt> de resúmenes de información, resumenes tabulares y gráficos
para la presentación de información de forma adecuada, para facilitar la
toma de decisiones.
