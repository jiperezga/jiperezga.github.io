...
Una alternativa es mediante resumenes númericos, los cual permiten
observar el comportamiento de un conjunto de observaciones mediante
diferentes medidas númericas, que se presentan de forma simple y
ordenada.

Existen diferentes funciones que permiten realizar resumenes númericos
...
que permiten realizar resumenes de variables tipo numéricas.
...
También es posible realizar resumenes numérico por grupos, en donde,
...
Una alternativa para presentar resumenes de variables, cuando éstas no
son númericas es mediante la construcción de tablas de frecuencias, las
...
variables, puede empleadase la función `table()` de la librería `base`,
...
para una variable se tiene, al diagráma de tallo y hojas, gráfico de
...
Este gráfico sirve para presentar de forma visual, datos númericos a
...
(mediana) y `$Q_3$`, el bigote inferor se calcula usualmente como
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-7-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-8-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-9-1.png)
...
(barras), éste muestra el comportamiendo de la distribución de las
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-10-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-11-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-12-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-13-1.png)
...
observaciones en una o más categorias diferentes. Este gráfico puede ser
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-14-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-14-2.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-15-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-15-2.png)

#### Gráfico de pareto

Este gráfico es similar al grafico de barras para una sola variable
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-16-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-17-1.png)

#### Gráfico de puntos

Este gráfico también es similar al grafico de barras, sirve para
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-18-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-18-2.png)
...
Este gráfico sirve para presentar de forma visual, datos númericos por
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-19-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-20-1.png)

#### Gráfico de medias

Este gráfico sirve para presentar de forma visual, grupos de datos
númericos a través de sus media y desviación estándar. El gráfico está
compuesto por un punto que representa el valor el valor promedio del
grupo de observaciones y las barras representan **una** desviación
estándar de la media. Este gráfico puede ser realizado mediante la
función `plotMeans` de la librería `RcmdrMisc`.
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-22-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-23-1.png)
...
Este gráfico muestra el comportamiendo de la distribución de las
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-24-1.png)
...
![](../../EstadisticaI/images/Clase03unnamed-chunk-25-1.png)
...
Hernández, F., and Correa, J. (2018). *Griáficos con r*. Universidad
