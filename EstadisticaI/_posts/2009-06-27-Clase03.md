...
<button id="Show30" class="btn btn-secondary">
Mostrar gráfico de barras para dos variables en <tt>R</tt>
</button>
<button id="Hide30" class="btn btn-info">
...
<button id="Show31" class="btn btn-secondary">
Mostrar gráfico de puntos para dos variables en <tt>R</tt>
</button>
<button id="Hide31" class="btn btn-info">
...
<button id="Show32" class="btn btn-secondary">
Mostrar gráfico de balón en <tt>R</tt>
</button>
<button id="Hide32" class="btn btn-info">
...
<p>
<img src="../../EstadisticaI/images/Clase03unnamed-chunk-35-2.png" alt="">
</p>
<h3 data-toc-skip>
Interpretación
</h3>
...
<button id="Show33" class="btn btn-secondary">
Mostrar gráfico de caja y bigotes en <tt>R</tt>
</button>
<button id="Hide33" class="btn btn-info">
Ocultar gráfico de caja y bigotes en <tt>R</tt>
</button>
<main id="botoncito33">
<h3 data-toc-skip>
...
<button id="Show34" class="btn btn-secondary">
Mostrar gráfico de caja y bigotes con intervalo de confianza para la
mediana en <tt>R</tt>
</button>
<button id="Hide34" class="btn btn-info">
...
<button id="Show35" class="btn btn-secondary">
Mostrar gráfico de medias en <tt>R</tt>
</button>
<button id="Hide35" class="btn btn-info">
...
<button id="Show36" class="btn btn-secondary">
Mostrar gráfico de dispersión por categorías en <tt>R</tt>
</button>
<button id="Hide36" class="btn btn-info">
