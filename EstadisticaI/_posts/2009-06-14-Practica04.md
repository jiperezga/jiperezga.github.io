...
37. En una industria automotríz, se sabe que diez por ciento de los
    ...
    el segundo intento?
38. Luego de una revisión exhaustiva, se encuentra que en promedio las
    obleas de silicio producidas por un fabricante tienen dos defectos
    grandes. Si `$Y$` representa al número de defectos por oblea ¿qué
    proporción de las obleas tiene más de cinco defectos grandes?
