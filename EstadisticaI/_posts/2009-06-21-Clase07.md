...
introduction: Introducción a variables aleatorias, distribuciones de probabilidad discretas y función de distribución acumulada
header-includes:
...
muestral S. Comúnmente las variables aleatorias se denotan por letras
mayúsculas del final del alfabeto `$(X,Y,Z)$` y a los valores observados
por letras minúsculas `$(x,y,z)$`.
