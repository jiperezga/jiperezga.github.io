...
<ol type="a">
<li>
\(\Gamma(\alpha) = (\alpha-1)\Gamma(\alpha)\), para todo \(\alpha>0\)
</li>
<li>
...
<p>
Suponga se realiza un estudio sobre el tiempo de transferencia de datos
de un sistema de red informática, en milisegundos. Si se encuentra que
el tiempo de transferencia se distribuye gamma con media \(37.5_{ms}\) y
desviación estándar de \(21.36196_{ms}\)
</p>
<ol>
<li>
...
de \(5\) minutos en entrar la próxima llamada al Call Center?
</p>
<h3 data-toc-skip>
Solución
</h3>
...
número promedio de automóviles que exceden el límite de velocidad
establecido para transitar por la avenida regional en un intervalo de
media hora es de \(12.3\) automóviles. Basados en lo anterior, cual es
la probabilidad de que transcurra más de \(10\) minutos hasta detectar
el próximo automovil que exceda el límite de velocidad por la avenida
regional.
</p>
<h3 data-toc-skip>
Solución
