...
introduction: Métodos no-paramétricos de series temporales, filtros lineales, suavizamiento y medias móviles.
header-includes:
...
Los filtros ayudan a determinar la tendencia reduciendo las
fluctuaciones locales y tambi´en se pueden usar como estimadores de la
tendencia cuando no es posible describirla mediante ecuaciones
param´etricas simples
