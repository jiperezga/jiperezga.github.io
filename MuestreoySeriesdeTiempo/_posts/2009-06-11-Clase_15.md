...
`\begin{align*} \lceil n\rceil = \frac{1}{\frac{1}{N}+\frac{N-1}{N}\frac{1}{n_0}} \quad \text{ con }\quad n_0 = \frac{Z_{\frac{\alpha}{2}}\sigma^2}{B^2} \end{align*}`
...
`$1-\alpha$` es el nivel de confianza, tal que
...
reemplazada por su estimador `$\hat{\sigma}^2y=\frac{N-1}{N}S^2$`.
...
dicha expresión puede ser reescrita como
`\begin{align*} \lceil n\rceil = \frac{1}{\frac{1}{N}+\frac{N-1}{N^3}\frac{1}{n_0}} \quad \quad n_0 = \frac{Z_{\frac{\alpha}{2}}\sigma^2}{B^2} \end{align*}`
...
proporción poblacional. `$1-\alpha$` es el nivel de confianza, tal que
`$\mathbb{P}(|\hat{\mu}-\mu|\leq B)= 1-\alpha$` <br> `$n_0$` es el
tamaño de la muestra cuando la población es infinita.

De no conocerse la varianza poblacional `$p$`, ésta puede ser
