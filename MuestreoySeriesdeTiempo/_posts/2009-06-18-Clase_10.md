...
gama de posibles modelos que pueden ajustarse, con el fin de facilitar
la escogencia del mejor modelo, **reduciendo su selección, solo aquel
que ofrezca la mejor calidad en los ajsutes y en los pronósticos
obtenidos mediante el proceso de validación cruzada**.
...
normales, es mediante el empleo de los gráficos Q-Q, el cual grafica los
...
realizarse mediante la función `qqnorm()` para gráficar los puntos
asociados a los cuantiles y la función `qqline()` para gráficar la linea
...
Un estadistico de prueba para probar tal juego de hipótesis, es
...
([1970](#ref-Box1970)), los autores George Box y Greta Ljung, dedicen
...
Una alternativa, considerada la mejor prueba para detectar normlaidad,
...
necesidad de que el tamaño de los grupos sea el mismo. Es más sensible
que el test de Levene a la falta de normalidad, pero si se está seguro
de que los datos provienen de una distribución normal, es la mejor
opción.
