...
<p>
Como para calcular la esperanza matemática requerimos de la función de
masa de probabilidad, entonces procedemos a calcula la función de
distribución para el número de niñas que hay en una familia que posee
\(3\) hijos.
</p>
...
A partir de ésta tabla se procede a realizar el cálculo de la esperanza
matemática de la variable aleatoria mediante la ecuación
...
es decir, se tedrá que en una familia que posea \(3\) hijos, se espera
encontrar que el número promedio de niñas será de \(1.5\) niñas.
</p>
</main>
...
<ol>
<li>
Calcule la \(\mathbb{E}(X+2)\).
</li>
<li>
Calcule la \(\mathbb{E}(3X)\).
</li>
<li>
Calcule la \(\mathbb{E}(X^2)\).
</li>
...
Finalmente, para encontrar la \(\mathbb{E}(X^2)\) se tendrá que
