...
de un nuevo aire acondicionado que fabrican en la compañia donde
...
tiempo de vida se distriuye Weibull con parámetros \(\alpha=2\) y
...
comporamiento de la tasa de fallas?
</p>
<h3 data-toc-skip>
Solución
</h3>
...
reduce que genera el catalizador solido en la reaccion química que se
...
tiempo. Por ejemplo, los equipos electronicos y mecánicos pueden iniciar
...
catalizador para \(3\), \(5\) y \(7\) años. Cuál es el comporamiento de
la tasa de fallas?
</p>
<h3 data-toc-skip>
Solución
...
\end{align*}\] Es decir, se aprecia que amedida que aumenta el número de
años, la tasa de riesgo va aumentando, es decir, se tendrá que amedida
que pasa el tiempo aumenta el riesgo de que el aire acondicionado falle.
</p>
</main>
