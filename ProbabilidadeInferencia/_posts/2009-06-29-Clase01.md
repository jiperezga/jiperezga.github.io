...
<ol type="1">
<li>
Escriba el **complemento** del evento \(A_1\).
</li>
<li>
Escriba la **unión** de los eventos \(B_1\) y \(B_2\).
</li>
<li>
Escriba la **intersección** entre los eventos \(A_1\) y \(A_2\).
</li>
<li>
Escriba un evento \(B_3\) que sea **mutuamente excluyente** del evento
\(B_2\).
</li>
<h3 data-toc-skip>
Solución
