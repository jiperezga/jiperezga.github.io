...
<ol>
<li>
Calcule la \(\mathbb{E}(60X)\)
</li>
<li>
Calcule la \(\mathbb{E}(X+40)\)
</li>
<li>
...
<li>
Para el cálculo de la \(\mathbb{E}(X^2)\), se tendrá que aplicar la
ecuación de la esperanza, tal que \[\begin{align*}
