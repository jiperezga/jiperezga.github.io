...
El tercer método, a pesar de realizar la asignación al igual que el
primer método, éste **no** es el operador habitual de asignación, pues
éste se encuentra reservado para otros propósitos, tales como darle
...
c <- c(-(0+3i), -1 + (0+12i), 3 + (0+74.23i))  # Complejo
d <- c("a", "3", "#")  # Carácter
