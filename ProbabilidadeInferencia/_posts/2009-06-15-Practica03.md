...
6.  Sea `$X$` una variable aleatoria continua con distribución de
    ...
    sea a lo más de 200? al menos 200?.
    </li>
    <li>
    ...
    <li>
    De una expresión para \(\mathbb{P}(X > x)\)?.
    </li>
    </ol>
...
21. Sea `$X$` una variable aleatoria discreta con distribución de
    ...
    `\begin{align*} \gamma_{1}&= \mathbb{E}\left[\left({\frac{X-\mu}{\sigma}}\right)^{3}\right]={\frac{\mu_{3}}{\sigma^{3}}}={\frac{\mathbb{E}\left[(X-\mu)^{3}\right]}{(\mathbb{E}\left[(X-\mu)^{2}\right])^{3/2}}}\\ \gamma_{1}&=\frac{\mathbb{E}(X^3)-3\mathbb{E}(X^2)\mathbb{E}(X)+2\mathbb{E}(X)^3}{Sd(X)^3} \end{align*}`
22. A partir de la siguiente función de masa de probabilidad
    ...
    `\begin{align*} \gamma_{2}&= \mathbb{E}\left[\left({\frac{X-\mu}{\sigma}}\right)^{4}\right] -3={\frac{\mu_{4}}{\sigma^{4}}} -3 ={\frac{\mathbb{E}\left[(X-\mu)^{4}\right]}{(\mathbb{E}\left[(X-\mu)^{2}\right])^{4/2}}} -3\\ \gamma_2&=\frac{\mathbb{E}(Y^4)-4\mathbb{E}(Y^3)\mathbb{E}(Y)+6\mathbb{E}(Y^2)\mathbb{E}(Y)^2 -3\mathbb{E}(Y)^4}{Sd(Y)^4} -3 \end{align*}`
