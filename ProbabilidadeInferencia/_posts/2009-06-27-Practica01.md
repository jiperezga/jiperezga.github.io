...
21. Suponga que la policía planea hacer respetar los límites de
    ...
    persona que excede el límite de velocidad cuando va a su trabajo
    tiene probabilidades de `$20\%$`, `$25\%$` y `$18\%$`,
    respectivamente, de pasar por las cámaras, ¿cuál es la probabilidad
