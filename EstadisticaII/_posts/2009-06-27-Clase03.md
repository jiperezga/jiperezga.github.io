...
las mujeres ganan en promedio \(2.3\) millones de pesos, mientras que
los hombres ganan en promedio \(2.6\) millones de pesos. Si el grupo de
investigación encuentra que los salarios se distribuyen normalmente con
desviaciones estándar de \(0.7\) millones de pesos y \(1.2\) millones de
pesos, respectivamente para mujeres y hombres, cuál es la probabilidad
de que la creencia de que las mujeres ganan en promedio menos dinero que
los hombres?
</p>
<h3 data-toc-skip>
Solución
...
normalmente con varianzas conocidas e iguales a \(\sigma_H^2=1.2^2\),
\(\sigma_M^2=0.7^2\), tal que \[\begin{align*}
...
\(n_H=270\) y \(n_M=250\) se encontró que \(\bar{X}_H=2.6\) y
\(\bar{X}_M=2.3\). Entonces al realizar las operaciones matemáticas
correspondientes, tendremos que \[\begin{align*}
