...
En <tt>R</tt>, tanto el intervalo de confianza para la respuesta media
como el intervalo de predicción se obtienen de la misma forma que en el
caso simple, mediante la función <tt>predict()</tt>, especificando en el
argumento <tt>newdata</tt> un <tt>data.frame</tt> con el valor de cada
una de las variables explicativas del modelo, por ejemplo,
<tt>predict(modelo, newdata = data.frame(x1 = 42, x2 = 4), interval =
“confidence”)</tt> o <tt>interval = “prediction”</tt> según el caso.
