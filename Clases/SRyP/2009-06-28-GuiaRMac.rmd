...
opts_chunk$set(echo=TRUE,
               ...
               message=FALSE,
               warning=FALSE,
               fig.path = paste0("../../SeminarioRyPython/images/", "GuiaMac"),
...
En la ventana Léeme, puede leer la información allí presentada si es de su interes, y de click en el botón Continuar

![](../../SeminarioRyPython/images/GuiaM4.jpg)

En la ventana de Licencia, se presenta el contraro de licencia de la aplicación, puede leer la información allí presentada si es de su interes, y de click en el botón Continuar
...
Esto hará, que se abra una ventana con un contrato de licencia, puede leer la información allí presentada si es de su interes, y de click en el botón Acepto.

![](../../SeminarioRyPython/images/GuiaM17.jpg)

Esto hará que aparezca la ventana de instalación de la herramienta para desarrolladores, espere un par de minutos mientras el proceso finaliza. Y con ésto podrá user el programa sin ningún tipo de problema.
