...
<button id="Show29" class="btn btn-secondary">Mostrar gráfico de barras para dos variables en <tt>R</tt></button>
<button id="Hide29" class="btn btn-info">Ocultar gráfico de barras para dos variables en <tt>R</tt></button>
<main id="botoncito29"> 
...
<button id="Show30" class="btn btn-secondary">Mostrar gráfico de balón en <tt>R</tt></button>
<button id="Hide30" class="btn btn-info">Ocultar gráfico de balón por categorías en <tt>R</tt></button>
<main id="botoncito30"> 
