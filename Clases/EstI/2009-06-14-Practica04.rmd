...
\end{align*}`
11. Dado que ya hemos lanzado al aire una moneda balanceada diez veces y no obtuvimos caras, ¿cuál es la probabilidad de que debemos lanzarla al menos dos veces más para obtener la primera cara? 
...
<li> ¿Cuál es la probabilidad de que en un día cualquiera, el número de tintos que toma un profesor se encuentre a más de una desviación estándar estándar de la media? Compare el resultado con el obtenido mediante el teorema de Chebyshev. </li>
</ol>	
...
38. Aproximadamente `$4\%$` de las obleas de silicio producidas por un fabricante tienen menos de dos defectos grandes. Si `$Y$` representa al número de defectos por oblea ¿qué proporción de las obleas tiene más de cinco defectos grandes?
