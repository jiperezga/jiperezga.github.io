...
<p> El número de carros que transitan por una glorieta en dos horas.</p>
<ul>
<li>El número de estudiantes que entrar a la universidad en un día.</li>
<li>Mirar el próximo carro que pasa por debajo de un tiene, y observar si es o no de color azul.</li>
...
<main id="botoncito5"> 
<h3 data-toc-skip> Ejercicio </h3> 
<p>Una gran distribuidora tiene $800$ equipos de computo, se sabe que $8$ de ellos están defectuosos. Una compañía compra $20$ de estos y le son despachados al azar. ¿Cuál es la probabilidad de que en la muestra se observen $2$ o más defectuosos. Emplee tanto la distribución hipergeométrica como la aproximación a binomial y comente sobre los resultados obtenidos</p>
