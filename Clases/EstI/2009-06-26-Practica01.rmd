...
## Encuesta
Las siguientes preguntas tienen como objetivo, recolectar información sobre los hábitos y preferencias de los estudiantes universitarios que cursan carreras administrativas, respecto al consumo de bebidas alcohólicas y consumo de drogas, y para ello se construye la siguiente encuesta, la cual se realiza a los estudiantes de forma anónima (No se piden datos personales).
...
9. Trabaja actualmente: Sí: <i class="far fa-square"></i> No: <i class="far fa-square"></i>
10. Ingresos mensuales: __________________________
11. Consume bebidas alcoholicas: Sí: <i class="far fa-square"></i> No: <i class="far fa-square"></i>
...
15. Consume algún tipo de droga: Sí: <i class="far fa-square"></i> No: <i class="far fa-square"></i>
