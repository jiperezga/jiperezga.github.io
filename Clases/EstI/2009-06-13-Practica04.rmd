...
23. Suponga en un proceso de producción, el número de fallas que tiene una maquina en un día antes de apagarse, es una variable aleatoria discreta `$X$` con función de densidad de probabilidad dada por 
`\begin{align*}
