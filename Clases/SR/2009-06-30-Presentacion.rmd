...
opts_chunk$set(echo=TRUE,
               ...
               message=FALSE,
               warning=FALSE,
               fig.path = paste0("../../SemilleroR/images/", "Presentacion"),
...
![Desarrollos vinculados con RStudio](../../SemilleroR/images/RStudio_Logos.png)
...
![IDE R Tools para Visual Studio](../../SemilleroR/images/Rvisualstudio.jpg)
...
Adicionalmente, se incentivará al estudiante para que aborde un problema de investigación en el área de interés, usando el programa <tt>R</tt> como soporte de la investigación realizada. Ésto con el fin de mejorar sus habilidades investigativas y manejo de los programas aquí enseñados.
