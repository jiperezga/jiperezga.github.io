...
opts_chunk$set(echo=TRUE,
               ...
               message=FALSE,
               warning=FALSE,
               fig.path = paste0("../../SemilleroR/images/", "Sesion01"),
...
## Palabras reservadas
El lenguaje <tt>R</tt> posee una serie de palabras reservadas que no permite que sean modificadas debido a que éstas **poseen atributos especiales** dentro del lenguaje de programación, y por ello, sus nombres no pueden ser usados como nombre de variables, funciones, etc.
...
```{r echo=FALSE}
library(kableExtra)
tabla <- rbind(c("if", "else", "repeat", "while", "NA_integer_"),
               c("for", "in", "next", "break", "NA_real_"),
               c("function", "TRUE", "FALSE", "...", "NA_complex_"),
               c("NULL", "NA", "Inf", "NaN", "NA_character_"))
...
El listado palabras reservadas en el lenguaje <tt>R</tt> también pueden ser consultadas en mediante el código 
...
Es por ello que tanto <tt>R</tt> posee información, sobre las funciones que pueden emplearse en los lenguajes de programación, mostrando los diferentes argumentos que posee, su significado, los valores que pueden extraerse de la función y ejemplos sobre su empleo.
...
## Estructura de datos
La idea de esta sección es resumir las estructuras básicas más importantes que puede tener un conjunto de datos en <tt>R</tt>.
...
![](../../SemilleroR/images/vector.jpg){ width=60% }
...
![](../../SemilleroR/images/matrix.jpg){ width=60% }
...
![](../../SemilleroR/images/array.jpg){ width=60% }
...
![](../../SemilleroR/images/dataframe.jpg){ width=60% }
