...
introduction:  |
  ...
  - Noción de aleatoriedad. <br>
  - Experimento aleatorio. <br>
  - Espacio muestral. <br>
  - Evento de un espacio muestral. <br>
  Teoría de conjuntos. <br>
  - Propiedades de teoría de conjuntos <br>
  Introducción a la probabilidad. <br>
  - Axiomas de probabilidad. <br>
  - Propiedades de Probabilidad. <br>
...
opts_chunk$set(echo=TRUE,
               ...
               message=FALSE,
               warning=FALSE,
               fig.path = paste0("../../EstadisticayProbabilidades/images/", "Clase02"),
...
<main id="botoncito3"> 
<h3 data-toc-skip> Ejercicio </h3> 
<p> Plantee los siguientes eventos basados en su correspondiente descripción.</p>
<ol type ="1">
<li> Considere el experimento de lanzar un dado convencional de $6$ caras.</br> Escriba el evento </li>
<ul>
<li>$A_1$: sacar un número primo en el dado.</li>
<li>$A_2$: sacar un número 3 en el dado.</li>
<li>$A_3$: sacar un $8$ en el dado.</li>
</ul>
<li>Considere el experimento de espera el tiempo que pasa hasta que el Decano de Ingenería salga de la oficina a comprar un tinto. Escriba el evento </li>
<ul>
<li>$B_1$: indica que el decano tarda en menos de $1$ hora en salir de la oficina para comprar tinto en la burbuja.</li>
<li>$B_2$: indica que el decano tarda entre $20$ y $70$ minutos en salir de la oficina para comprar tinto en la burbuja.</li>
</ul>
</ol>
...
<main id="botoncito4"> 
<h3 data-toc-skip> Ejercicio </h3> 
<p> Suponga los siguientes eventos.</p>
<ul>
<li>$A_1$: sacar un número primo en un dado de $6$ caras.</li>
<li>$A_2$: sacar un número $3$ en un dado de $6$ caras.</li>
<li>$A_3$: sacar un $8$ en un dado de $6$ caras.</li>
<li>$B_1$: indica que el decano tarda en menos de $1$ hora en salir de la oficina para comprar tinto en la burbuja.</li>
<li>$B_2$: indica que el decano tarda entre $20$ y $70$ minutos en salir de la oficina para comprar tinto en la burbuja.</li>
</ul>
</ol>

<p>Basados en lo puntos muestrales de cada uno de los eventos anteriores</p>
<ol type="1">
