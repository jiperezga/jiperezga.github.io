...
datos <- read_xlsx("../../Dataset/ingresorealhoteles2019.xlsx")
...
```{r echo=FALSE}
# Gráfico avanzado con plotly
plot_ly(x = ~AP2$index, y = ~errorNP, width = 700, height = 400, type = "bar") %>%
...
```{r echo=FALSE}
# Gráfico avanzado con plotly
plot_ly(x = ~ingH2$index, y = ~errorAH, width = 700, height = 400, type = "bar") %>%
...
plot_ly(x = ~ingH2$index, y = ~ingH2$value, mode = 'lines', width = 700, height = 400, type = "scatter", name = "Datos") %>%
