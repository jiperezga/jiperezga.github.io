...
La suavización exponencial de Holt-Winters, puede ser empleado cuando la variación estacional es constante o no constante. En el primer caso, cuando la variación estacional de la serie es constante, se emplea el método de suavización exponencial Holt-Winters aditivo, mientras que, en el segundo caso, cuando la variación estacional de la serie no es constante, se emplea el método de suavización exponencial Holt-Winters multiplicativo.
...
`\begin{align*}
a_t=\alpha (Y_t-S_t) + (1 - \alpha) (a_{t-1} + b_{t-1})
\end{align*}`
...
`\begin{align*}
a_t=\alpha \left(\frac{Y_t}{S_t}\right) + (1 - \alpha) (a_{t-1} + b_{t-1})
\end{align*}`
