...
La prueba Breusch-Pagan puede realizarse en <tt>R</tt>, mediante la función `bp.test()` de la librería `lmtest`, o su versión mejorada conocida como la prueba Cook-Weisberg, que puede realizarse mediante la función `ncvTest()` de la librería `lmtest`.
...
donde `$(a\wedge b) = min(a,b)$`. La prueba Goldfeld-Quandt puede realizarse en <tt>R</tt>, mediante la función `gq.test()` de la librería `lmtest`.
