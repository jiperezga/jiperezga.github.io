...
<button class="Show1">Mostrar código R</button>
<button class="Hide1">Ocultar código R</button>
<main id="botoncito1"> 
...
fechas1 <- time(Serie1)
tagList(plot_ly(x = ~fechas1, y = ~Serie1, mode = 'lines', text = paste("Valor =", round(Serie1, 3)), width = 700, height = 400, type = "scatter") %>% layout(title="Producción mensual de juguetes", xaxis = list(title ="Mes"), yaxis = list(title = "Producción mensual")) %>%
...
<button class="Show2">Mostrar código R</button>
<button class="Hide2">Ocultar código R</button>
<main id="botoncito2"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show3">Mostrar código R</button>
<button class="Hide3">Ocultar código R</button>
<main id="botoncito3"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show4">Mostrar código R</button>
<button class="Hide4">Ocultar código R</button>
<main id="botoncito4"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show5">Mostrar código R</button>
<button class="Hide5">Ocultar código R</button>
<main id="botoncito5"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show6">Mostrar código R</button>
<button class="Hide6">Ocultar código R</button>
<main id="botoncito6"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show7">Mostrar código R</button>
<button class="Hide7">Ocultar código R</button>
<main id="botoncito7"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show8">Mostrar código R</button>
<button class="Hide8">Ocultar código R</button>
<main id="botoncito8"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show9">Mostrar código R</button>
<button class="Hide9">Ocultar código R</button>
<main id="botoncito9"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show10">Mostrar código R</button>
<button class="Hide10">Ocultar código R</button>
<main id="botoncito10"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show11">Mostrar código R</button>
<button class="Hide11">Ocultar código R</button>
<main id="botoncito11"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show12">Mostrar código R</button>
<button class="Hide12">Ocultar código R</button>
<main id="botoncito12"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show13">Mostrar código R</button>
<button class="Hide13">Ocultar código R</button>
<main id="botoncito13"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show14">Mostrar código R</button>
<button class="Hide14">Ocultar código R</button>
<main id="botoncito14"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show15">Mostrar código R</button>
<button class="Hide15">Ocultar código R</button>
<main id="botoncito15"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show16">Mostrar código R</button>
<button class="Hide16">Ocultar código R</button>
<main id="botoncito16"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
<code><span class="c1"># Gráfico básico</span><span class="w">
...
<button class="Show17">Mostrar código R</button>
<button class="Hide17">Ocultar código R</button>
<main id="botoncito17"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
...
<button class="Show18">Mostrar código R</button>
<button class="Hide18">Ocultar código R</button>
<main id="botoncito18"> 
<section class="language-r highlighter-rouge" style="width: 100%;"><section class="highlight" style="width: 100%;"><pre class="highlight" style="width: 100%;">
<code><span class="c1">## Gráfico Básico</span><span class="w">
