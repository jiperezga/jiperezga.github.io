...
@Gutierrez2015[, pp. 184] señala que, a pesar de que el muestreo por conglomerados otorga una ganancia significativa en términos operativos, logísticos y financieros, el muestreo por conglomerados pierde eficiencia en términos estadísticos. Y basado en lo anterior, el autor plantea una serie de comentarios acerca del muestreo por conglomerados.
...
hogares en los barrios conglomerados (dispersión geográfica, reducción de costos).
   * La población objetivo se encuentra muy dispersa (geográficamente) o aparece en agrupaciones
...
2. Aplicación del diseño muestral y selección de la muestras (o sub-muestras) de cada marco de
muestreo.
...
* **Independencia:** El sub-muestreo de cualquier unidad de muestreo se lleva a cabo de manera independiente con las otras unidades de muestreo, tanto en etapas superiores, inferiores o en la misma etapa.
...
`\begin{align*}
\bar{y}_d = \frac{n_1'}{n'} \bar{y}_1 + \frac{n_2}{n'} \bar{y}_1
\end{align*}`
