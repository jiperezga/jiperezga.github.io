...
## Intervalos de confianza para una media
Sea `$X_1, X_2, \ldots, X_n$` una muestra aleatoria *iid* de tamaño `$n$` con media `$\mathbb{E}(X_{1})=\mu$`, y varianza `$Var(X_{1})=\sigma^2<\infty$`, entonces dependiendo de las condiciones, se tendrán los siguientes intervalos de confianza.
