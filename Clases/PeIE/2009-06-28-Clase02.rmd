...
<img src="../../ProbabilidadeInferencia/images/ReglaMultiplicativa.jpg" alt="">
<br>
...
<img src="../../ProbabilidadeInferencia/images/DiagramadeArbol.jpg" alt="">
<br>
...
<img src="../../ProbabilidadeInferencia/images/DiagramadeArbol2.jpg" alt="">
<br>
...
<img src="../../ProbabilidadeInferencia/images/DiagramadeArbol3.jpg" alt="">
<br>
...
\end{align*}`
o alternativamente, al aplicar la formula de la <a href="../../ProbabilidadeInferencia/PeIEClase02.html#regla-multiplicativa" target="\_blank">Regla multiplicativa</a>, tenemos que
`\begin{align*}
...
\end{align*}`
En donde, al aplicar la formula de la <a href="../../ProbabilidadeInferencia/PeIEClase02.html#regla-multiplicativa" target="\_blank">Regla multiplicativa</a> en el numerador, y la formula de la <a href="../../ProbabilidadeInferencia/PeIEClase02.html#probabilidad-total" target="\_blank">Probabilidad total</a> en el denominador, tenemos que
...
Al detallar la ecuación más detenidamente, observamos que los eventos $A_1, A_2, A_3$ son <strong>mutuamente excluyentes</strong> y <strong>exhaustivos</strong>, lo cual nos permite poder calcular la $\mathbb{P}(B)$ mediante el teorema de <a href="../../ProbabilidadeInferencia/PeIEClase02.html#probabilidad-total" target="\_blank">Probabilidad total</a>, y la probabilidad $\mathbb{P}(A_3 \cap B)$ mediante el teorema de la <a href="../../ProbabilidadeInferencia/PeIEClase02.html#regla-multiplicativa" target="\_blank">Regla multiplicativa</a>. Lo cual nos lleva a la siguiente expresión.
$$\begin{align*}
