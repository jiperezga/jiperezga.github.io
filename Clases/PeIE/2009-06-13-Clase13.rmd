...
Basados e la información anterior, calcule la probabilidad de que la proporción de egresados que tienen un salario superior a $2$ millones de pesos sea mayor al $40\%$.  </p>
...
Entonces, si los $1$ representa los éxitos, tendremos un total de $4$ éxitos en las $15$ muestras, entonces podemos aplicar la fórmula de frecuencia relativa para calcular la proporción muestral de egresados que poseen salarios superiores a $2$ millones.
$$\begin{align*}
