...
<ol type ="a">
  ...
  <li> obtiene una media muestral de $9.4_{cm}$ y la verdadera media $\mu=9.6cm$
  </li>
  <li> obtiene una media muestral de $9.4_{cm}$ y la verdadera media $\mu=9.8cm$
  </li> 
  <li>Si la desviación estándar es igual a $2_{cm}$, calcule la probabilidad de cometer Error Tipo I.
  </li>
  <li>Si la desviación estándar es igual a $2_{cm}$, Calcule la probabilidad de cometer Error Tipo II, si la verdadera media $\mu=9.8cm$.
  </li>
</ol>
