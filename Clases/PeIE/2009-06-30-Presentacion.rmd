...
kable(cbind(data.frame(
  ...
  Porcentaje = c("20%", "25%", "20%", "20%", "10%", "10%"),
  ...
  "Semana para Evaluación" = c("Cuarta semana", "Novena semana", "Decimotercera semana", "Decimosexta semana", "Sexta semana", "Tercera, Séptima, Décima, Decimoquinta Semana"),
