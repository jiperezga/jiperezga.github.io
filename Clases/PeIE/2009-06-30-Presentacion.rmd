...
kable(cbind(data.frame(
  "Evaluación" = c("Examen No.1", "Trabajo No.1", "Examen No.2","Trabajo No.2", "Examen No.3", "Seguimiento")),
  Porcentaje = c("15%", "15%", "20%", "15%", "20%", "15%"),
  ...
  Modalidad = c("Individual", "Parejas", "Individual", "Parejas", "Individual", "Individual")),
