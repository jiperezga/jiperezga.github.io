...
2. Sea `$X_1, X_2, \ldots, X_n$` una muestra aleatoria `$iid$` de una distribución Binomial con parámetros desconocido `$p$` y parámetro `$n$` conocido o desconocido, con función de distribución dada por
`\begin{align*}
