...
Si se supone que los tiempos de secado se distribuye normalmente con varianzas diferentes. Calcule la probabilidad de que el tiempo medio de secado de la pintura `$B$` sea como máximo el tiempo medio de secado de la pintura `$A$`.
