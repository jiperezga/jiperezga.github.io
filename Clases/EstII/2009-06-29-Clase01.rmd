...
title: "Clase 01"
main-class: 'clase'
permalink: /EstadisticaII/EstI:title.html
tags:
...
<button id="Show6" class="btn btn-secondary">Mostrar Ejercicio Manejo de Tabla Normal Estándar</button>
<button id="Hide6" class="btn btn-info">Ocultar Ejercicio Manejo de Tabla Normal Estándar</button>
<main id="botoncito6"> 
<h3 data-toc-skip> Ejercicio </h3> 
