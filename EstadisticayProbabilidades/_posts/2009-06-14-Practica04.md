...
4.  La magnitud de temblores registrados en una Japón durante los
    últimos meses puede modelarse como mediante una distribución
    Chi-Cuadrado con con media `$2$` grados de libertad, según se mide
    en la escala de Richter.
    <ol type="a">
    <li>
    Encuentre la probabilidad de que un temblor que ocurra en esta
    región, sea mayor a \(2.3\) en la escala de Ritcher.
    </li>
    <li>
    Si ocurre un temblor que es mayor a \(2.3\) en la ecala de Ritcher,
    cuál es la probabilidad de que éste sea a lo más de \(3.5\) en dicha
    escala de medición?.
    </li>
    </ol>
