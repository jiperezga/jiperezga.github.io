...
Por su parte, para el código presentado en <tt>Python</tt> se empleará
un fondo de color rojo tal como se presenta a continuación.

``` python
'Ejemplo código Python'
```

Mientas que, para los resultados o salidas obtenidas tanto en <tt>R</tt>
como en <tt>Python</tt> se empleará un fondo de color gris, tal como se
